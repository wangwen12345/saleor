...
// 优先使用单独的 CODEGEN_SCHEMA_URL 以便在构建阶段可用（如 Linux 无法解析 host.docker.internal）
let schemaUrl = process.env.CODEGEN_SCHEMA_URL || process.env.NEXT_PUBLIC_SALEOR_API_URL;
