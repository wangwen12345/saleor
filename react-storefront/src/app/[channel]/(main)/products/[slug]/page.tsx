...
import { normalizeSaleorImageUrl } from "@/lib/image";
...
export default async function Page(props: {
	...
	const productJsonLd: WithContext<Product> = {
		...
		"@type": "Product",
		image: product.thumbnail?.url ? normalizeSaleorImageUrl(product.thumbnail.url) : undefined,
		...(selectedVariant
			? {
				...
				<div className="md:col-span-1 lg:col-span-5">
					{firstImage && (
						<ProductImageWrapper
							...
							width={1024}
							height={1024}
							src={normalizeSaleorImageUrl(firstImage.url) as string}
						/>
					)}
				</div>
